      ...
      <header className="container mx-auto flex justify-between items-center">
        ...
        <section>
          <ul className="flex justify-between items-center">
            ...
            <li className="px-2">
              <Link
                className="text font-base text-orange-600 hover:text-orange-700 flex items-center"
                to="/cart"
              >
                Cart
                <span className="bg-orange-600 text-white text-xs ml-2 py-1 px-2 rounded">
                  {items?.length}
                </span>
              </Link>
            </li>
